    ...
    <>
      {!isVisible && (
        <button
          ...
          className="absolute left-4 top-[calc(1rem+env(safe-area-inset-top))] z-20 flex h-11 w-11 items-center justify-center rounded-2xl bg-black/42 text-white/58 shadow-[0_18px_48px_rgba(0,0,0,0.42),inset_0_1px_0_rgba(255,255,255,0.05)] backdrop-blur-2xl active:scale-95 md:hidden"
          aria-label="搜索日记"
        >
